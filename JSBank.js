...
🛡️  SECURITY ANALYSIS:
  ...
  • findJWTTokens()             - Find and decode JWT tokens (in storage, cookies, and JSON objects)
  • findMSALTokens()            - Find Microsoft MSAL authentication tokens and accounts
...
(function() {
    ...
    console.log('Commands: findJWTTokens(), findMSALTokens() [Microsoft Auth tokens], decodeJWT(token), jwtLab.*');
})();
